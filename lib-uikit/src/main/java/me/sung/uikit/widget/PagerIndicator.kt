...
class PagerIndicator : LinearLayout {
    ...
    private fun init(attrs: AttributeSet?, defStyle: Int) {
        ...
        indicatorColor = a.getColor(R.styleable.PagerIndicator_IndicatorColor, indicatorColor.toInt()).toLong()
        shadowColor = a.getColor(R.styleable.PagerIndicator_IndicatorShadowColor, shadowColor.toInt()).toLong()
        selectedWidth = a.getDimension(R.styleable.PagerIndicator_IndicatorSelectedWidthDimension, selectedWidth)
        dia = a.getDimension(R.styleable.PagerIndicator_IndicatorDiaDimension, dia)
        space = a.getDimension(R.styleable.PagerIndicator_IndicatorSpaceDimension, space)
        shadowRadius = a.getDimension(R.styleable.PagerIndicator_IndicatorShadowRadiusDimension, shadowRadius)
        isAnimation = a.getBoolean(R.styleable.PagerIndicator_IndicatorIsAnimation, isAnimation)
        isShadow = a.getBoolean(R.styleable.PagerIndicator_IndicatorIsShadow, isShadow)
